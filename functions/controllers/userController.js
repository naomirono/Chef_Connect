...
const emailUser = 'smtp-mail.outlook.com'
...
exports.registerUser = async (req, res, next) => {
  ...
  try {
    ...
    if (newUser) {
      console.log('User created:', newUser); // Add this line for debugging
...
exports.forgotPassword = async (req, res, next) => {
  ...
  try {
    ...
    if (user) {
      ...
      const resetUrl = `${functions.config().frontend.url}/resetpassword/${resetToken}`;

...
const SpecialOccasionsSection = () => {
    ...
    Weddings: [
      {
        ...
        image: 'https://chefconnectapp.s3.ap-south-1.amazonaws.com/CateringS3.png', 
      },
    ...
    Birthdays: [
      {
        ...
        image: 'https://chefconnectapp.s3.ap-south-1.amazonaws.com/CateringS1.png', 
      },
  ...
  return (
    ...
    <div className="absolute top-0 right-72 w-full h-full">
      ...
      <img
        src="https://chefconnectapp.s3.ap-south-1.amazonaws.com/Splash.svg"  
        alt="Splash Overlay"
